...
void SettingsDialog::saveToSettings()
{
    ...
    VisingoApp::instance()->loadSettings();
#if defined(QWEBENGINEPAGE_SETNETWORKACCESSMANAGER)
    VisingoApp::networkAccessManager()->loadSettings();
    VisingoApp::cookieJar()->loadSettings();
#endif
    VisingoApp::historyManager()->loadSettings();
}
...
{
#if defined(QWEBENGINEPAGE_SETNETWORKACCESSMANAGER)
    CookiesDialog *dialog = new CookiesDialog(VisingoApp::cookieJar(), this);
    dialog->exec();
#endif
}
...
{
#if defined(QWEBENGINEPAGE_SETNETWORKACCESSMANAGER)
    CookiesExceptionsDialog *dialog = new CookiesExceptionsDialog(VisingoApp::cookieJar(), this);
    dialog->exec();
#endif
}

...
CLINGOPATH = $$PWD/../clingo

INCLUDEPATH += $$CLINGOPATH/app/shared/include
INCLUDEPATH += $$CLINGOPATH/libgringo
INCLUDEPATH += $$CLINGOPATH/libclasp
INCLUDEPATH += $$CLINGOPATH/libprogram_opts
INCLUDEPATH += $$CLINGOPATH/libprogram_opts/src
INCLUDEPATH += $$CLINGOPATH/app/clingo/src

INCLUDEPATH += $$CLINGOPATH/build/release
DEPENDPATH += $$CLINGOPATH/build/release

unix: LIBS += $$CLINGOPATH/build/release/app/clingo/src/clingo_app.o
unix: LIBS += $$CLINGOPATH/build/release/app/clingo/src/clasp/clasp_app.o

unix: PRE_TARGETDEPS += $$CLINGOPATH/build/release/libshared.a
unix: PRE_TARGETDEPS += $$CLINGOPATH/build/release/libgringo.a
unix: PRE_TARGETDEPS += $$CLINGOPATH/build/release/libclasp.a
unix: PRE_TARGETDEPS += $$CLINGOPATH/build/release/libprogram_opts.a

unix: LIBS += -L$$CLINGOPATH/build/release/ -lshared -lgringo -lclasp -lprogram_opts
